...
const post: Post = {
  ...
  Body: () => (
    <>
      ...
      <ol>
        <li><strong>Passport.</strong> Current, with valid stamp or visa.</li>
        <li><strong>Permit document.</strong> Work permit, study permit, PGWP, COPR/landing paper, or PR card.</li>
        <li><strong>SIN.</strong> Permanent or temporary 9-prefixed.</li>
        <li><strong>Proof of Calgary address.</strong> Lease, utility bill, or bank statement, within last 60 days.</li>
        <li><strong>Proof of income.</strong> Last 2 paystubs <em>or</em> signed offer letter on letterhead <em>or</em> 3 months of bank statements (self-employed).</li>
        <li><strong>Driver&apos;s licence.</strong> Alberta licence preferred; Class 7 learner&apos;s or international permit acceptable for the financing application.</li>
      </ol>
      <h2>Visa-by-visa documentation notes</h2>
      <h3>PGWP (Post-Graduation Work Permit)</h3>
      <p>
        Include your SAIT, U of C, or other Canadian institution graduation confirmation if
        you have it. PGWP holders with a confirmed Canadian degree get priority routing
        through the manufacturer-backed newcomer programs.
      </p>
