...
const post: Post = {
  ...
  Body: () => (
    <>
      ...
      <p>
        Passport with valid stamp. Permit document. SIN (temporary 9-prefixed SINs accepted).
        Calgary lease, utility bill, or bank statement showing address. Last 2 paystubs or a
        signed offer letter. Canadian driver&apos;s licence or international permit with an
        Alberta Class 7 learner&apos;s.
      </p>
