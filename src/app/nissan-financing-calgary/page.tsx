...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Brand-new Nissan financing in Calgary through our dealer partners. Rogue, Kicks, Sentra, Armada with current programs. Newcomer & bad credit welcome.",
  path: SLUG,
});
...
const FAQ = [
  {
    ...
    answer:
      "Yes. Our specialist works directly with dealer partners in Calgary. New 2026 Rogue, Kicks, Sentra, Armada, and Pathfinder are all available with current Nissan Canada Finance programs.",
  },
  {
  ...
  {
    question: "Where can I pick up my Nissan in Calgary?",
    answer:
      "We coordinate vehicle delivery through our dealer partners. We do most of the paperwork remotely. You only need to visit for final signing and vehicle delivery.",
  },
  {
...
export default function Page() {
  return (
    <PageShell
      slug={SLUG}
      title="Nissan financing in Calgary through our dealer partners"
      tagline="Nissan financing"
      intro="The reason every other Calgary broker can't match this page: they don't have a dealer relationship. We do. Our specialist works directly with dealer partners and brings the current Nissan Canada Finance programs to NewWheels customers directly, including new-vehicle approvals for newcomers and credit rebuilds."
    ...
    >
      ...
      <ul>
        ...
        <li>
          ...
          on the public website. Our specialist knows about them in real time.
        </li>
        <li>
          <strong>Trade-in advantage.</strong> Our dealer partners&apos; used-car desk can
          appraise your trade in person and apply it as down payment.
        </li>
      </ul>

      <h2>Disclosure: NewWheels works with a Calgary Nissan dealer</h2>
      <p>
        We disclose this clearly so you can decide. Our specialist is licensed and earns a commission on Nissan sales. NewWheels also operates independently and
