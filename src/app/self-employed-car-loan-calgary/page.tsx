...
const FAQ = [
  ...
  },
  {
    ...
    answer:
      "We know. Calgary self-employed buyers regularly understate income for tax purposes. We use stated-income programs that look at bank deposits rather than line 150. Be honest with us and we'll structure the file correctly.",
  },
];
...
export default function Page() {
  return (
    <PageShell
      ...
      intro="Oil and gas contractors, electricians, plumbers, drywallers, Uber drivers, and photographers. Calgary's self-employed economy is enormous. Most online brokers can't handle non-T4 income. We can. NOA, bank statements, contracts, or platform earnings statements all work as income proof."
